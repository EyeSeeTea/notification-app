...
function stubApiLoad() {
    ...
    getStub
        .withArgs("/attributes", {
            ...
            filter: 'code:in:[user_noInterpretationMentionNotifications,user_noInterpretationSubcriptionNotifications]',
        })
...
describe('load', () => {
    ...
    describe("set email", () => {
        ...
        it('persists the value and return new settings', async () => {
            const { isValid, updated, settings: newSettings } =
    ...
    describe("set emailNotifications", () => {
        beforeEach(() => stubApiSetUserSettings("keyMessageEmailNotification", false))
    ...
    describe("set smsNotifications", () => {
        beforeEach(() => stubApiSetUserSettings("keyMessageSmsNotification", false))
